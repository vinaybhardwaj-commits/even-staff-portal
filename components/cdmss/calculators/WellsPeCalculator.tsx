...
const FIELDS: FormField[] = [
  { key: 'dvt_signs', label: 'Clinical signs/symptoms of DVT (objective leg swelling + pain on palpation)', type: 'bool', required: true,
  ...
  { key: 'malignancy', label: 'Malignancy (treatment ≤ 6 mo or palliative)', type: 'bool', required: true,
