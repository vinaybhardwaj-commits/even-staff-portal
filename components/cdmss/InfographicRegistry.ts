/**
 * v1.7 Sprint E — central registry for custom fenced-code-block infographic types.
 *
 ...
 *   4. Mention the block + its schema in the /ask SYSTEM_PROMPT
 *
...
export const INFOGRAPHIC_BLOCKS: Record<string, {
  ...
  'dosing-card': { schema: DosingCardSchema, component: DosingCard },
  // v1.8 candidates: lab-panel, ddx-tree, drug-interaction, vitals-trend
};
